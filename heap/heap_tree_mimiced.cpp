 ...
 *      The key points lie in the exchanging between the i-th element with parent(i) or left/right(i) element.
 *      We mean exchanging the element in the vector (heap-array) by moving not COPYing.
 *
 *  
 * 
 * */
