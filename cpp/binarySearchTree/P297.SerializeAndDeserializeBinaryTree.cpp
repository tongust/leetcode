...
public:
	...
	string serialize(TreeNode* root) {
                ...
                while(!mque.empty()) {
                        ...
                        if (it->left != nullptr) {
                                ...
                                //words.push_back(int(it->left != nullptr ? it->left->val : _MAX_S_32));
	...
	TreeNode* deserialize(string data) {
        ...
        vector<std::shared_ptr<TreeNode>> del;
...
int main ()
{
        vector<shared_ptr<TreeNode>> del;
        /*
        TreeNode *p, *q, *root;
        p = new TreeNode(0);
        root = p;
        del.push_back(shared_ptr<TreeNode>(p));
        q = new TreeNode(1);
        del.push_back(shared_ptr<TreeNode>(q));
        ...
        */
        ...
        string ss = "[7,3,6,8,2,3,6,4,7,6,5,1,null,3,null,8,7,9,9,6,5,3,3,0,null,0,0,0,null,1,6,2]";
        ss = "[1, 22]";
        
        auto r1 = cd.deserialize(ss);
        cout <<  cd.serialize(r1) << endl;
